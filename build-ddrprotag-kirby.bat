...
ant -f C:/Users/A.Petersell/Dropbox/DITA-SRCME/seminarwork-ddrprotag/build-petersell.xml -Dpubname=ddrprotag-kirby -logger org.dita.dost.log.DITAOTBuildLogger %1